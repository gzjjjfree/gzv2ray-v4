...
const (
	LoggerService_RestartLogger_FullMethodName = "/gzv2ray.core.app.log.command.LoggerService/RestartLogger"
)
...
var LoggerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gzv2ray.core.app.log.command.LoggerService",
