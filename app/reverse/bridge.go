...
func (b *Bridge) Start() error {
	fmt.Println("in app-reverse-bridge.go func (b *Bridge)  Start()")
	return b.monitorTask.Start()
}

func (b *Bridge) Close() error {
	fmt.Println("in app-reverse-bridge.go func (b *Bridge) Close() ")
...
func (w *BridgeWorker) Start() error {
	fmt.Println("in app-reverse-bridge.go func (w *BridgeWorker) Start()")
	return nil
}

func (w *BridgeWorker) Close() error {
	fmt.Println("in app-reverse-bridge.go func (w *BridgeWorker) Close() ")
	return nil
}
