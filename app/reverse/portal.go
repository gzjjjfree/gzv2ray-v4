...
func (p *Portal) Start() error {
	fmt.Println("in app-reverse-portal.go func (p *Portal) Start()")
...
func (p *Portal) Close() error {
	fmt.Println("in app-reverse-portal.go func  (p *Portal) Close()")
...
func (o *Outbound) Dispatch(ctx context.Context, link *transport.Link) {
	if err := o.portal.HandleConnection(ctx, link); err != nil {
		newError("failed to process reverse connection")
		common.Interrupt(link.Writer)
	}
}

func (o *Outbound) Start() error {
	fmt.Println("in app-reverse-portal.go func (o *Outbound) Start()")
	return nil
}
