...
import (
	...
	"github.com/gzjjjfree/gzv2ray-v4/common/bitmask"
	...
	"github.com/gzjjjfree/gzv2ray-v4/proxy/vmess"
	vmessaead "github.com/gzjjjfree/gzv2ray-v4/proxy/vmess/aead"
)
...
func (h *SessionHistory) Close() error {
	fmt.Println("inproxy-vmess-encoding-server.go func (h *SessionHistory) Close()")
	return h.task.Close()
}
...
func (s *ServerSession) DecodeRequestHeader(reader io.Reader) (*protocol.RequestHeader, error) {
	...
	case errorAEAD == vmessaead.ErrNotFound:
		...
		if s.isAEADForced {
			return nil, drainConnection(newError("invalid user: VMessAEAD is enforced and a non VMessAEAD connection is received. You can still disable this security feature with environment variable gzv2ray.vmess.aead.forced = false . You will not be able to enable legacy header workaround in the future."))
		}
