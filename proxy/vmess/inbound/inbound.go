...
import (
	...
	feature_inbound "github.com/gzjjjfree/gzv2ray-v4/features/inbound"
	...
	"github.com/gzjjjfree/gzv2ray-v4/proxy/vmess/encoding"
...
func (h *Handler) Close() error {
	fmt.Println("in proxy-vmess-inbound-inbound.go func (h *Handler) Close()")
