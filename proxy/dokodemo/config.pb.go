...
type Config struct {
	...
	// List of networks that the Dokodemo accepts.
	Networks []net.Network `protobuf:"varint,7,rep,packed,name=networks,proto3,enum=gzv2ray.core.common.net.Network" json:"networks,omitempty"`
	// Deprecated: Marked as deprecated in proxy/dokodemo/config.proto.
...
var file_proxy_dokodemo_config_proto_rawDesc = []byte{
	...
	0x79, 0x2e, 0x64, 0x6f, 0x6b, 0x6f, 0x64, 0x65, 0x6d, 0x6f, 0x1a, 0x18, 0x63, 0x6f, 0x6d, 0x6d,
	...
	0x2f, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcc,
	0x02, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x3d, 0x0a, 0x07, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x67, 0x7a, 0x76,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x4b, 0x0a, 0x0c,
	...
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x3c, 0x0a, 0x08, 0x6e, 0x65, 0x74,
	0x77, 0x6f, 0x72, 0x6b, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x67, 0x7a,
	...
	0x28, 0x0d, 0x52, 0x09, 0x75, 0x73, 0x65, 0x72, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x42, 0x71, 0x0a,
	0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x7a, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2e, 0x63, 0x6f, 0x72,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x64, 0x6f, 0x6b, 0x6f, 0x64, 0x65, 0x6d, 0x6f,
	...
	0x2d, 0x76, 0x34, 0x2f, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2f, 0x64, 0x6f, 0x6b, 0x6f, 0x64, 0x65,
	0x6d, 0x6f, 0xaa, 0x02, 0x1b, 0x47, 0x7a, 0x56, 0x32, 0x52, 0x61, 0x79, 0x2e, 0x43, 0x6f, 0x72,
...
var file_proxy_dokodemo_config_proto_goTypes = []any{
	(*Config)(nil),          // 0: gzv2ray.core.proxy.dokodemo.Config
	(*net.IPOrDomain)(nil),  // 1: gzv2ray.core.common.net.IPOrDomain
	(*net.NetworkList)(nil), // 2: gzv2ray.core.common.net.NetworkList
	(net.Network)(0),        // 3: gzv2ray.core.common.net.Network
}
var file_proxy_dokodemo_config_proto_depIdxs = []int32{
	1, // 0: gzv2ray.core.proxy.dokodemo.Config.address:type_name -> gzv2ray.core.common.net.IPOrDomain
	2, // 1: gzv2ray.core.proxy.dokodemo.Config.network_list:type_name -> gzv2ray.core.common.net.NetworkList
	3, // 2: gzv2ray.core.proxy.dokodemo.Config.networks:type_name -> gzv2ray.core.common.net.Network
