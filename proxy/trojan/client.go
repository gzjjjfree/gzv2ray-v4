...
func NewClient(ctx context.Context, config *ClientConfig) (*Client, error) {
	fmt.Println("in proxy-trojan-client.go func  NewClient")
...
func (c *Client) Process(ctx context.Context, link *transport.Link, dialer internet.Dialer) error {
	fmt.Println("in proxy-trojan-client.go func (c *Client) Process")
...
func init() {
	fmt.Println("in proxy-trojan-client.go func init()")
