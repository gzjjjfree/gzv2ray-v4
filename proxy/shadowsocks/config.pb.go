...
type Account struct {
	...
	CipherType CipherType `protobuf:"varint,2,opt,name=cipher_type,json=cipherType,proto3,enum=gzv2ray.core.proxy.shadowsocks.CipherType" json:"cipher_type,omitempty"`
...
type ServerConfig struct {
	...
	Network    []net.Network  `protobuf:"varint,3,rep,packed,name=network,proto3,enum=gzv2ray.core.common.net.Network" json:"network,omitempty"`
}
...
var file_proxy_shadowsocks_config_proto_rawDesc = []byte{
	...
	0x12, 0x1e, 0x67, 0x7a, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x70,
	...
	0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1a, 0x63, 0x6f, 0x6d, 0x6d,
	...
	0x70, 0x65, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8d, 0x01, 0x0a, 0x07, 0x41, 0x63,
	...
	0x64, 0x12, 0x4b, 0x0a, 0x0b, 0x63, 0x69, 0x70, 0x68, 0x65, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2a, 0x2e, 0x67, 0x7a, 0x76, 0x32, 0x72, 0x61, 0x79,
	...
	0x52, 0x07, 0x69, 0x76, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x22, 0xa7, 0x01, 0x0a, 0x0c, 0x53, 0x65,
	...
	0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x3a, 0x0a, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f,
	0x72, 0x6b, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x67, 0x7a, 0x76, 0x32, 0x72,
	...
	0x6f, 0x72, 0x6b, 0x22, 0x54, 0x0a, 0x0c, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x12, 0x44, 0x0a, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x67, 0x7a, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2e, 0x63, 0x6f,
	...
	0x74, 0x52, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2a, 0x5c, 0x0a, 0x0a, 0x43, 0x69, 0x70,
	...
	0x47, 0x43, 0x4d, 0x10, 0x01, 0x12, 0x0f, 0x0a, 0x0b, 0x41, 0x45, 0x53, 0x5f, 0x32, 0x35, 0x36,
	0x5f, 0x47, 0x43, 0x4d, 0x10, 0x02, 0x12, 0x15, 0x0a, 0x11, 0x43, 0x48, 0x41, 0x43, 0x48, 0x41,
	0x32, 0x30, 0x5f, 0x50, 0x4f, 0x4c, 0x59, 0x31, 0x33, 0x30, 0x35, 0x10, 0x03, 0x12, 0x08, 0x0a,
	0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x04, 0x42, 0x7a, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e, 0x67,
	0x7a, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x78,
	0x79, 0x2e, 0x73, 0x68, 0x61, 0x64, 0x6f, 0x77, 0x73, 0x6f, 0x63, 0x6b, 0x73, 0x50, 0x01, 0x5a,
	0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x7a, 0x6a, 0x6a,
	...
	0x6b, 0x73, 0xaa, 0x02, 0x1e, 0x47, 0x7a, 0x56, 0x32, 0x52, 0x61, 0x79, 0x2e, 0x43, 0x6f, 0x72,
...
var file_proxy_shadowsocks_config_proto_goTypes = []any{
	(CipherType)(0),                 // 0: gzv2ray.core.proxy.shadowsocks.CipherType
	(*Account)(nil),                 // 1: gzv2ray.core.proxy.shadowsocks.Account
	(*ServerConfig)(nil),            // 2: gzv2ray.core.proxy.shadowsocks.ServerConfig
	(*ClientConfig)(nil),            // 3: gzv2ray.core.proxy.shadowsocks.ClientConfig
	(*protocol.User)(nil),           // 4: gzv2ray.core.common.protocol.User
	(net.Network)(0),                // 5: gzv2ray.core.common.net.Network
	(*protocol.ServerEndpoint)(nil), // 6: gzv2ray.core.common.protocol.ServerEndpoint
}
var file_proxy_shadowsocks_config_proto_depIdxs = []int32{
	0, // 0: gzv2ray.core.proxy.shadowsocks.Account.cipher_type:type_name -> gzv2ray.core.proxy.shadowsocks.CipherType
	4, // 1: gzv2ray.core.proxy.shadowsocks.ServerConfig.user:type_name -> gzv2ray.core.common.protocol.User
	5, // 2: gzv2ray.core.proxy.shadowsocks.ServerConfig.network:type_name -> gzv2ray.core.common.net.Network
	6, // 3: gzv2ray.core.proxy.shadowsocks.ClientConfig.server:type_name -> gzv2ray.core.common.protocol.ServerEndpoint
