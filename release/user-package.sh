...
build_v2() {
	...
	LDFLAGS="-s -w -buildid= -X github.com/gzjjjfree/gzv2ray-v4.codename=${CODENAME} -X github.com/gzjjjfree/gzv2ray-v4.build=${BUILDNAME} -X github.com/gzjjjfree/gzv2ray-v4.version=${VERSIONTAG}"
