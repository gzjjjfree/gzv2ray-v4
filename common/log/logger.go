...
func (l *generalLogger) Close() error {
	fmt.Println("in common-log-logger.go func (l *generalLogger) Close()")
	return l.done.Close()
}
...
func (w *consoleLogWriter) Close() error {
	fmt.Println("in common-log-logger.go func (w *consoleLogWriter) Close()")
	return nil
}
...
func (w *fileLogWriter) Close() error {
	fmt.Println("in common-log-logger.go func (w *fileLogWriter) Close()")
	return w.file.Close()
}
