...
func Generate(parent *Certificate, opts ...Option) (*Certificate, error) {
	...
	if err != nil {
		return nil, errors.New("failed to generate self private key")
	}
	parentKey = selfKey
	if parent != nil {
		...
		if err != nil {
			return nil, errors.New("failed to parse parent private key")
		}
		parentKey = pKey
	}
	...
	if parent != nil {
		...
		if err != nil {
			return nil, errors.New("failed to parse parent certificate")
		}
		parentCert = pCert
	}
