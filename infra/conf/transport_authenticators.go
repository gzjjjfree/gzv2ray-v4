...
import (
	...
	"github.com/gzjjjfree/gzv2ray-v4/transport/internet/headers/http"
	"github.com/gzjjjfree/gzv2ray-v4/transport/internet/headers/noop"
	"github.com/gzjjjfree/gzv2ray-v4/transport/internet/headers/srtp"
	"github.com/gzjjjfree/gzv2ray-v4/transport/internet/headers/tls"
	"github.com/gzjjjfree/gzv2ray-v4/transport/internet/headers/utp"
	"github.com/gzjjjfree/gzv2ray-v4/transport/internet/headers/wechat"
	"github.com/gzjjjfree/gzv2ray-v4/transport/internet/headers/wireguard"
)
...
func (v *AuthenticatorRequest) Build() (*http.RequestConfig, error) {
	...
	if len(v.Headers) > 0 {
		...
		for _, key := range headerNames {
			value := v.Headers[key]
			if value == nil {
				return nil, errors.New("empty HTTP header value")
			}
