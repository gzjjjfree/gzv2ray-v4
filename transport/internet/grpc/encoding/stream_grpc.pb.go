...
const (
	GunService_Tun_FullMethodName = "/gzv2ray.core.transport.internet.grpc.encoding.GunService/Tun"
)
...
var GunService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gzv2ray.core.transport.internet.grpc.encoding.GunService",
