...
import (
	...
	http_proto "github.com/gzjjjfree/gzv2ray-v4/common/protocol/http"
	"github.com/gzjjjfree/gzv2ray-v4/common/session"
	"github.com/gzjjjfree/gzv2ray-v4/transport/internet"
	v2tls "github.com/gzjjjfree/gzv2ray-v4/transport/internet/tls"
)
...
func (h *requestHandler) ServeHTTP(writer http.ResponseWriter, request *http.Request) {
	fmt.Println("in transport-internet-websocket-hub.go func (h *requestHandler) ServeHTTP")
...
func ListenWS(ctx context.Context, address net.Address, port net.Port, streamSettings *internet.MemoryStreamConfig, addConn internet.ConnHandler) (internet.Listener, error) {
	fmt.Println("in transport-internet-websocket-hub.go func  ListenWS")
	l := &Listener{
		addConn: addConn,
	}
...
func (ln *Listener) Close() error {
	fmt.Println("in transport-internet-websocket-hub.go func (ln *Listener) Close()")
	if ln.locker != nil {
		ln.locker.Release()
	}
