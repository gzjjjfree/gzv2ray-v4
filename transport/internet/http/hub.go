...
func (l *Listener) Close() error {
	fmt.Println("in transport-internet-http-hub.go func (l *Listener) Close()")
	if l.locker != nil {
		l.locker.Release()
	}
...
func (fw flushWriter) Write(p []byte) (n int, err error) {
	fmt.Println("in transport-internet-http-hub.go func (fw flushWriter) Write")
	if fw.d.Done() {
...
func (l *Listener) ServeHTTP(writer http.ResponseWriter, request *http.Request) {
	fmt.Println("in transport-internet-http-hub.go func (l *Listener) ServeHTTP")
	host := request.Host
...
func Listen(ctx context.Context, address net.Address, port net.Port, streamSettings *internet.MemoryStreamConfig, handler internet.ConnHandler) (internet.Listener, error) {
	fmt.Println("in transport-internet-http-hub.go func Listen")
